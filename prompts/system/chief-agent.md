...
In addition to the tools above, you may have access to other custom tools depending on the environment.

Guidelines:
{{GUIDELINES}}{{APPEND_SYSTEM_PROMPT}}{{PROJECT_CONTEXT}}{{SKILLS}}
